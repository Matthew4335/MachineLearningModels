...
class NeuralNet:
    ...
    def softmax(self, u):
        """
        Performs softmax function element-wise.
    ...
    def gradient_descent(self, x, y, iter=60000, use_momentum=False, local_test=False):
        ...
        **For LOCAL TEST append and print out loss at every iteration instead of every 1000th multiple.
        ...
        for i in range(iter):
            ...
            o2 = self.forward(x, self.use_dropout)
            self.backward(y, o2, self.use_dropout, use_momentum)
            loss = self.cross_entropy_loss(y, o2)
